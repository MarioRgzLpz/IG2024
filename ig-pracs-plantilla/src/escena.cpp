...
Escena2::Escena2()
{
   ...
   objetos.push_back( new P2Rejilla(15,16));
...
Escena4::Escena4()
{
   ...
   objetos.push_back(new CasaUrbaP4(1));
...
Escena5::Escena5() {
   ...
   objetos.push_back(new NodoUrbaP5(5));
}
